...
func (app *application) healthcheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	// so that we can include double-quote  characters in the JSON without needing to escape them?
	...
	// If you forget to this, Go will default to sending a "Content-Type: text/plain; charset=utf-8" header instead.
