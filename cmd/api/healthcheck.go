...
func (app *application) healthcheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	// This is just a small nicety to make it easier to view in terminal applications.
	js = append(js, '\n')
	// At this point we know that encoding the data worked without any problems,
	// so we can safely set any necessary HTTP headers for a successful response.
